...
The optimal policies for each fraction can be extracted manually. pol4 is the policy for fraction 4. but one must know what index represents which sparing factor
